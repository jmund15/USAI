...
public partial class MidStatus : Node2D
{
    ...
    public Label UsaiLabel;

    private AnimationPlayer _usaiAnim;
    ...
    public override void _Ready()
	{
        ...
        _usaiAnim = GetNode<AnimationPlayer>("UsaiAnim");
        _usaiAnim.Play("usaiTalk");

        UsaiLabel = GetNode<Label>("UsaiText");
        ...
        for (int i=0; i<candidates.Count;i++) 
        {
            ...
            resLabel.Text= string.Format("{0} is Polling at {1}%!", candidates[i].PlayerName, ((int)candidates[i].TotalScore));
        }
